...
export const SETTINGS_NAV_GROUPS: SettingsNavGroup[] = [
  ...
  },
  {
    ...
    children: [
      {
        label: 'Silero TTS',
        sectionDomId: 'settings-section-voice',
        keywords: ['silero', 'голос', 'озвучка', 'tts', 'aidar', 'baya'],
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        sectionDomId: 'settings-section-telephony',
    ...
    children: [
      {
        ...
        sectionDomId: 'settings-section-mail',
