...
import { MessageDownloadBar } from '@/components/chat/MessageDownloadBar'
import {
    ...
    >
      ...
      <div
        className={cn(
          ...
          isJarvisHealthReport(message.content) && 'min-w-[min(100%,520px)]',
          isUser
      ...
      >
        {isUser ? (
          <>
            ...
            <MessageDownloadBar content={message.content} role="user" />
          </>
          ...
          <div className="markdown-body">
            <ChatMarkdown content={message.content} />
            <MessageDownloadBar content={message.content} role="assistant" />
          </div>
        )}
      </div>
    </div>
