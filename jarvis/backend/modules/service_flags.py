...
def silero_service_enabled() -> bool:
    return xtts_service_enabled()
...
def service_flags_payload(settings: dict | None = None) -> dict:
    ...
    return {
        ...
        "silero_speaker": str(s.get("silero_speaker") or "aidar"),
        "silero_tempo": float(s.get("silero_tempo") or 1.0),
    }
